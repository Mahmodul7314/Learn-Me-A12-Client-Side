...
const Footer = () => {
    return (
        <div>
            <footer className="max-w-screen-xl px-10  divide-y bg-[#FFFBEE] text-gray-800">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				...
				<span className="self-center text-2xl font-semibold"> <a className=" text-5xl font-bold">Edu<span className="text-yellow-600">Forge</span></a></span>
			</a>
		</div>
	...
	<div className="py-6 text-sm text-center text-gray-400">© 2000 LearnMe All rights reserved.</div>
</footer>
